...
class TestRAGServiceRetrieve:
    ...
    def test_returns_citations_when_data_seeded(self, chroma_with_data):
    ...
    def test_returns_empty_list_when_collection_empty(self, chroma_client):
    ...
    def test_returns_empty_list_when_vectorstore_raises(self, chroma_client):
...
class TestRAGServiceQueryConstruction:
    ...
    def _get_query_string(self, chroma_client, ticker, sector, roe, divida_ebitda):
        ...
        with patch("app.services.rag_service.Chroma") as mock_chroma_cls, \
            ...
            svc = RAGService(chroma_client=chroma_client)
            svc.retrieve(ticker=ticker, sector=sector, roe=roe, divida_ebitda=divida_ebitda)

            call_args = mock_vectorstore.similarity_search.call_args
            return call_args[0][0]  # First positional arg is the query string

    def test_query_contains_low_debt_when_divida_ebitda_below_1(self, chroma_client):
    ...
    def test_query_contains_moderate_debt_when_divida_ebitda_1_to_3(self, chroma_client):
    ...
    def test_query_contains_high_debt_when_divida_ebitda_above_3(self, chroma_client):
    ...
    def test_query_uses_sector_moat_hint_for_known_sector(self, chroma_client):
    ...
    def test_query_uses_default_hint_for_unknown_sector(self, chroma_client):
    ...
    def test_query_includes_sector_and_roe(self, chroma_client):
